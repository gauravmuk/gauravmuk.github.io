!function (e) {
    ...
    var n = function () {
        function e(t) {
            var r = this;
            this.VERSION = Number(150704), this.log = {
                setLevel: function (e) {
                    r.currentLogLevel = e
                }
        ...
        return e.shouldLog = function () {
            ...
            if (void 0 === e.proxyMethodsCreated) {
                ...
                for (var t = {
                    ...
                    var i = n[r], o = void 0 !== console[i], s = t[i], a = o && (e.shouldLog() || "error" === s);
    ...
    var o = function (e) {
        function t(r) {
            ...
            return Object.defineProperty(n, "message", {
                ...
                configurable: !0,
                enumerable: !1,
                value: new Error(r).stack,
                writable: !0
            }), Object.setPrototypeOf(n, t.prototype), n)
        }
    ...
    Object.defineProperty(t, "__esModule", {value: !0});
    var s = r(0), a = r(3), u = o(r(1)), d = function (e) {
        function t(r) {
            var n = e.call(this, Object.getOwnPropertyNames(t.prototype)) || this;
            return window.OneSignal = n, n.playPushes(r), n
        }

        return i(t, e), t.prototype.isPushNotificationsSupported = function () {
            return !1
            ...
            a.ProcessOneSignalPushCalls.processItem(this, e)
        }, t.prototype.stubFunction = function (e, t, r) {
        }, t.prototype.stubPromiseFunction = function (e, r, n) {
            ...
            if (e) for (var t = 0, r = e; t < r.length; t++) {
                var n = r[t];
                try {
                    this.push(n)
                } catch (e) {
    ...
    var OneSignalStubES6 = function (e) {
        function OneSignalStubES6(t) {
            var r = e.call(this, Object.getOwnPropertyNames(OneSignalStubES6.prototype)) || this;
            return r.directFunctionCallsArray = new Array, r.preExistingArray = t, r
        }

        return i(OneSignalStubES6, e), OneSignalStubES6.prototype.isPushNotificationsSupported = function () {
            return !0
        }, OneSignalStubES6.prototype.stubFunction = function (e, t, r) {
            e.directFunctionCallsArray.push({functionName: t, args: r, delayedPromise: void 0})
        }, OneSignalStubES6.prototype.stubPromiseFunction = function (e, t, r) {
            var n = void 0, i = new Promise(function (e, t) {
    ...
    n = function () {
        ...
        function t(t) {
            ...
            var n, i, o, s = r(/(ipod|iphone|ipad)/i).toLowerCase(), a = !/like android/i.test(t) && /android/i.test(t),
                u = /nexus\s*[0-6]\s*/i.test(t), d = !u && /nexus\s*[0-9]+/i.test(t), c = /CrOS/.test(t),
                l = /silk/i.test(t), f = /sailfish/i.test(t), p = /tizen/i.test(t), m = /(web|hpw)os/i.test(t),
                v = /windows phone/i.test(t), h = (/SamsungBrowser/i.test(t), !v && /windows/i.test(t)),
                b = !s && !l && /macintosh/i.test(t), g = !a && !f && !p && !m && /linux/i.test(t),
                w = r(/edge\/(\d+(\.\d+)?)/i), y = r(/version\/(\d+(\.\d+)?)/i),
                S = /tablet/i.test(t) && !/tablet pc/i.test(t), O = !S && /[^-]mobi/i.test(t), P = /xbox/i.test(t);
            /opera/i.test(t) ? n = {
                name: "Opera",
                opera: e,
                ...
                chrome: e,
                version: r(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)
            } : a ? n = {name: "Android", version: y} : /safari|applewebkit/i.test(t) ? (n = {
                name: "Safari",
                safari: e
            }, y && (n.version = y)) : s ? (n = {name: "iphone" == s ? "iPhone" : "ipad" == s ? "iPad" : "iPod"}, y && (n.version = y)) : n = /googlebot/i.test(t) ? {
                name: "Googlebot",
                googlebot: e,
                version: r(/googlebot\/(\d+(\.\d+))/i) || y
            } : {
                name: r(/^(.*)\/(.*) /),
                version: (i = /^(.*)\/(.*) /, o = t.match(i), o && o.length > 1 && o[2] || "")
        ...
        function s(e, n, i) {
            ...
            var a = "" + s.version;
            for (var u in e) if (e.hasOwnProperty(u) && s[u]) {
    ...
    function o() {
        return "" === i.default.name && "" === i.default.version ? i.default._detect(navigator.userAgent) : i.default
    }

    t.redetectBrowserUserAgent = o, t.isPushNotificationsSupported = function () {
        var e = o(), t = navigator.userAgent || "";
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0});
    var n = r(8), i = r(5), o = r(4), s = function () {
        function e() {
        }
        ...
        return e.addScriptToPage = function (e) {
        ...
        }, e.serviceWorkerSupportsPush = function () {
            return void 0 !== self.registration
        }, e.addOneSignalPageES6SDKStub = function () {
            var e = window.OneSignal, t = Array.isArray(e);
            ...
            e.isServiceWorkerRuntime() ? e.serviceWorkerSupportsPush() && self.importScripts(e.getPathAndPrefix() + "OneSignalSDKWorker.js?v=" + e.VERSION) : n.isPushNotificationsSupported() ? (e.addScriptToPage(e.getPathAndPrefix() + "OneSignalPageSDKES6.js?v=" + e.VERSION), e.addOneSignalPageES6SDKStub()) : e.addOneSignalPageES5SDKStub()
        }, e
    }();
    t.OneSignalShimLoader = s, s.VERSION = Number(150704)
}, function (e, t, r) {
    "use strict";
